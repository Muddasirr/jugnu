  ...
  return (
    ...
    <main className="min-h-screen flex flex-col bg-[#111] text-white">
      ...
      <section className="flex flex-col md:flex-row flex-1">
        {/* Left block */}
        <div className="flex flex-1 bg-[#AC1514] justify-center items-center p-10 text-center">
          <div>
...
>
  CLICK HERE
        ...
        {/* Right block */}
        <div className="flex flex-1 bg-[#1C1C1C] justify-center items-center p-10 text-center">
          <div>
            <div className="flex justify-center mb-6">

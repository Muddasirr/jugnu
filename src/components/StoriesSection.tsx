      ...
      <div className="">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-2xl font-extrabold max-w-4xl mx-auto leading-relaxed">
            A Comprehensive Collection of Completed Stories That Reflect Our
...
/>
                ...
                <h3 className="text-[32px] md:text-[50px] font-semibold mb-6">{story.title}</h3>
                <p className="text-white text-[21.24px] font-normal leading-relaxed">
  {story.description}
</p>

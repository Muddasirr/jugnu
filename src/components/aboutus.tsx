    ...
    <section className="min-h-screen bg-white text-black px-6 md:px-16 py-12 flex flex-col md:flex-row items-start gap-10">
      ...
      <div className="md:w-1/2 space-y-5">
        ...
        <div className="flex gap-4 pt-4">
          <button className="border border-red-600 text-red-600 font-bold px-4 py-2 rounded-full hover:bg-red-600 hover:text-white transition uppercase">
            READ JUGNU’S STORY
          </button>
          <button className="border border-gray-400 text-gray-700 font-bold px-4 py-2 rounded-full hover:bg-gray-200 transition uppercase">
            ABOUT THE FOUNDER
          </button>
        </div>
      </div>

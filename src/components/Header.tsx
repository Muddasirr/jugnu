...
const Header: React.FC = () => {
  ...
  return (
    <header className="bg-[#AC1514] text-white top-0 z-50 shadow-md">
      <div className="container flex items-center justify-between px-4 py-4">
        {/* Logo */}
        <Link href="/" className="flex-shrink-0 z-50">
          <img src="/logojugnu.svg" alt="Jugnu Logo" className="h-10 md:h-12 w-auto" />
        </Link>

        {/* Desktop Navigation */}
        <nav className="hidden lg:flex items-center lg:space-x-4 xl:space-x-6 2xl:space-x-8 text-base lg:text-lg font-normal tracking-wide">
        ...
        <div className="hidden lg:flex items-center lg:space-x-3 xl:space-x-4 2xl:space-x-6">
          ...
          <Link href="/survivor-stories">
            <button className="bg-white text-black px-2 lg:px-3 2xl:px-4 py-2 text-[10px] lg:text-xs font-bold uppercase tracking-wider hover:bg-gray-100 transition shadow-sm whitespace-nowrap">
              SURVIVOR'S DIRECTORY
            </button>
          </Link>

          <a href="https://www.google.com" className="bg-black text-white px-2 lg:px-3 2xl:px-4 py-2 text-[10px] lg:text-xs font-bold uppercase tracking-wider hover:bg-gray-900 transition shadow-sm whitespace-nowrap">
            LEAVE THIS SITE
          </a>
        </div>
